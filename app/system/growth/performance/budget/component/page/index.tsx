			...
			<Div className={'flex flex-row items-center justify-between gap-2'}>
				<Div className={'flex flex-row items-center gap-2.5'}>
					<Paragraph className={'flex flex-row items-center gap-2.5 text-sm font-semibold'}>
						<Wallet className={'size-4 text-primary'} strokeWidth={2.500} /> Budget
					</Paragraph>
				...
				<Card className={'flex max-w-md flex-col items-center gap-6 p-12 text-center'}>
					<Div className={'relative'}>
						...
						<Div className={'relative flex size-20 items-center justify-center rounded-full bg-primary-500/10'}>
							<DollarSign className={'size-10 text-primary-500'} strokeWidth={1.5} />
						</Div>
					</Div>

					<Div className={'flex flex-col gap-2'}>
						<Span className={'text-xl font-bold'}>Budget Management</Span>
						<Small className={'text-neutral-500'}>This feature is currently under development</Small>
					</Div>

					<Div className={'mt-2 flex flex-col gap-1'}>
						<Small className={'text-sm text-neutral-400'}>Track and manage your marketing budget</Small>
						<Small className={'text-sm text-neutral-400'}>with powerful analytics tools</Small>
					</Div>
				</Card>
			</Div>
		</Section>
