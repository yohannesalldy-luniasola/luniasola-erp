...
export const LABEL		          = 'Direct Purchase' 	   					   as const 
export const PATH  		          = '/system/growth/datasource/direct' as const 
export const TABLE                = 'direct_purchase' 		 	 	 	 	   as const
...
export const SCHEMA = z.object({
	...
	purchase_amount : z.coerce.number().int().min(0, 'Amount must be a positive number').optional().nullable(),
	purchase_pic    : z.string().optional().nullable(),
})
...
export const SCHEMA_SEARCH_PARAMS 		  = SEARCH_PARAMS.extend({
	...
	purchase_pic : z.string().optional(),
})
