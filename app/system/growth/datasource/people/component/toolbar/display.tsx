...
import type { Column } from '@/app/system/growth/datasource/people/action/schema'

import { ToolbarDisplay as ToolbarDisplayRoot }                                                from '@/app/system/component/toolbar/display'
import { LABEL, TABLE_COLUMN, TABLE_COLUMN_INITIAL, TABLE_COLUMN_LABELS, TABLE_COLUMN_LOCKED } from '@/app/system/growth/datasource/people/action/schema'
