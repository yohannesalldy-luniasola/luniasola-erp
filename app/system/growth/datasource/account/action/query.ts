...
import type { SchemaSearchParam, ColumnTable } from '@/app/system/growth/datasource/account/action/schema'
...
import { LABEL, PATH, TABLE, TABLE_COLUMN_SORT } from '@/app/system/growth/datasource/account/action/schema'
...
export const list = cache(async (params: SchemaSearchParam): Promise<Readonly<{ data : readonly ColumnTable[], metadata : SupabaseMeta}>> => {
	...
	const { page, limit, query, status, sort } = params
